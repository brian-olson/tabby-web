...
class ProxyAuthMiddleware(BaseMiddleware):
    ...
    When running behind an authenticating proxy (like UnboundBytes tenant-auth),
    this middleware trusts the X-Auth-* headers set by the proxy and automatically
    logs in users based on their email.
    ...
    def __call__(self, request):
        ...
        user_id = request.META.get("HTTP_X_AUTH_USER_ID", "")
